...
Blockly.Java.initAndroidPermisionAndIntent = function(){
    ...
    jBridgeAndroidPermisions["fine_location"] = "<uses-permission android:name=\"android.permission.ACCESS_FINE_LOCATION\" />\r\n\r\n    ";
    ...
    jBridgeMethodAndTypeToPermisions["locationsensor"] = ["fine_location"];
    jBridgeMethodAndTypeToPermisions["webviewer"] = ["internet"];

    //TODO Create a new variable for this. its just a temp fix
    jBridgeAndroidIntents["listpicker"]="<activity android:name=\"com.google.appinventor.components.runtime.ListPickerActivity\">
         </activity> \r\n\r\n        \r\n\r\n";
    //This includes method Names or Type
